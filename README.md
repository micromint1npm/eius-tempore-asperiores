# @micromint1npm/eius-tempore-asperiores
...
```
npm install @micromint1npm/eius-tempore-asperiores
```
...
```js
const germanMetadata = require('@micromint1npm/eius-tempore-asperiores');
